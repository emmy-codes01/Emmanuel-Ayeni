 ...
 ScrollReveal().reveal(".reveal1", {
  ...
  return (
     <div className='flex flex-col text-white items-stretch gap-4 px-5 lg:px-85 py-5 lg:py-15'>
      {/* Heading */}
      <div>
        <h4 className='reveal md:gap-14 lg:gap-52 bg-white/3 border border-zinc-900 border-3xl p-5 rounded-3xl text-2xl font-semibold shadow-md shadow-indigo-500'>Logos and Brand Identity<span className='text-indigo-500'> Designs</span></h4>
      </div>
